...
**Vercel:** set `PULSE_API_URL` to your Render URL (or rely on the built-in default `https://groww-pulse-api-uss6.onrender.com`). Do **not** set `NEXT_PUBLIC_API_URL` to `localhost` on Vercel — it is baked in at build time.
